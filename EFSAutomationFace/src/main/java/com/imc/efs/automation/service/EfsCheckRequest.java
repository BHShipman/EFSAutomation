...
/**
 * <p>Java class for efsCheckRequest complex type.
 * 
...
@XmlType(name = "efsCheckRequest", propOrder = {
    "company",
    "description",
    "driverId",
    "driverName",
...
public class EfsCheckRequest {
     ...
     * This is why there is not a <CODE>set</CODE> method for the fileUploads property.
     * 
     * <p>
